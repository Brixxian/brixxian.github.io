...
$(document).ready(() => {
  ...
  for (let i in links) {
    ...
    $("#marquee").append(
      `<a href="https://steamcommunity.com/id/${link.link}" target="_BLANK">${link.name}</a>`
    );
    $("#marquee").append(
      `<a href="https://brixxian.de/dc" target="_BLANK"> « steam artworks »     </a>`
    );
    $("#marquee").append(
      `<a href="https://github.com/brixxian" target="_BLANK"> « github »     </a>`
    );
    $("#marquee").append(
      `<a href="https://brixxian.de/dc" target="_BLANK"> « discord »     </a>`
    );
    $("#marquee").append(
      `<a href="https://steamcommunity.com/id/${link.link}" target="_BLANK">${link.name}</a>`
    );
  ...
  app.titleChanger(["brixxian.github.io"]);
  app.iconChanger([
...
$.getJSON(ipgeolocation, (data) => {
  writeLine(
    [
      "Authenticating...",
      "Granting access to <span style='font-size: 14px; color: #06d;'>[brixxian.github.io]</span>...",
    ],
    30,
    () => {
